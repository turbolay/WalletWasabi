...
public class Global
{
	...
	{
		HostedServices.Register<BlockstreamInfoFeeProvider>(() => new BlockstreamInfoFeeProvider(TimeSpan.FromSeconds(10), new(Network, HttpClientFactory)) { IsPaused = true }, "Blockstream.info Fee Provider");
