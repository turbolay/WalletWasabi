...
public class TorProcessManager : IAsyncDisposable
{
	...
	private async Task RestartingLoopAsync(CancellationToken globalCancellationToken)
	{
		...
		while (!cancellationToken.IsCancellationRequested)
		{
			...
			{
				Logger.LogError("Tor cannot be started because your chip is not compatible with the executable. If your chip is a Mac Silicon (M1/M2), please install Rosetta 2.");
			}
			catch (Exception ex)
			{
